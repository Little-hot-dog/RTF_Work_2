...
Задание мне показалось легких, но Unity начал выдавать ошибку ```NullReferenceException: Object reference not set to an instance of an object```
как только я начал менять условия. Даже когда я все вернул в исхожный вариант, ошибка не пропала. 
